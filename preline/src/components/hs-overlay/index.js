...
class HSOverlay extends Component {
    ...
    open($overlayEl) {
        ...
        if ($openedOverlayEl) {
            ...
            return this.close($openedOverlayEl)
                .then(() => {
                    this.open($overlayEl)
                    this.openNextOverlay = false
                })
    ...
    _buildBackdrop($overlayEl) {
        ...
        let backdropClasses = 'transition duration fixed inset-0 z-50 bg-gray-900 bg-opacity-50 bg-opacity-80 hs-overlay-backdrop'
